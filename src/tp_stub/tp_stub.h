...
#ifndef _WIN32
	#error Sorry, currently tp_stub.h can only be used in Win32 VC++ or Clang compilers.
#endif
...
extern void * TVPImportFuncPtr9bb70418d5f8f3207f1e555deb68165e;
...
public:
	...
	void ToNumber(class tTJSVariant & dest) const
	{
		if(!TVPImportFuncPtr9bb70418d5f8f3207f1e555deb68165e)
		{
			static char funcname[] = "void tTJSVariantString::ToNumber(class tTJSVariant &) const";
			TVPImportFuncPtr9bb70418d5f8f3207f1e555deb68165e = TVPGetImportFuncPtr(funcname);
		}
		typedef void(__stdcall * __functype)(const tTJSVariantString *, class tTJSVariant &);
		((__functype)(TVPImportFuncPtr9bb70418d5f8f3207f1e555deb68165e))(this, dest);
	}
...
void TJSNativeClassRegisterNCM(tTJSNativeClass * cls , const tjs_char * name , iTJSDispatch2 * dsp , const tjs_char * classname , tTJSNativeInstanceType type , tjs_uint32 flags = 0);
...
tjs_int TVPCancelEvents(iTJSDispatch2 * source , iTJSDispatch2 * target , const ttstr & eventname , tjs_uint32 tag = 0);
...
void TVPCancelEventsByTag(iTJSDispatch2 * source , iTJSDispatch2 * target , tjs_uint32 tag = 0);
...
ttstr TVPGetOSName();
bool TVPGetAsyncKeyState(tjs_uint keycode , bool getcurrent = true);
iTJSDispatch2 * TVPGetScriptDispatch();
void TVPExecuteScript(const ttstr & content , tTJSVariant * result = NULL);
void TVPExecuteScript(const ttstr & content , iTJSDispatch2 * context , tTJSVariant * result = NULL);
void TVPExecuteExpression(const ttstr & content , tTJSVariant * result = NULL);
void TVPExecuteExpression(const ttstr & content , iTJSDispatch2 * context , tTJSVariant * result = NULL);
void TVPExecuteScript(const ttstr & content , const ttstr & name , tjs_int lineofs , tTJSVariant * result = NULL);
void TVPExecuteScript(const ttstr & content , const ttstr & name , tjs_int lineofs , iTJSDispatch2 * context , tTJSVariant * result = NULL);
void TVPExecuteExpression(const ttstr & content , const ttstr & name , tjs_int lineofs , tTJSVariant * result = NULL);
void TVPExecuteExpression(const ttstr & content , const ttstr & name , tjs_int lineofs , iTJSDispatch2 * context , tTJSVariant * result = NULL);
void TVPExecuteStorage(const ttstr & name , tTJSVariant * result = NULL , bool isexpression = false , const tjs_char * modestr = NULL);
void TVPExecuteStorage(const ttstr & name , iTJSDispatch2 * context , tTJSVariant * result = NULL , bool isexpression = false , const tjs_char * modestr = NULL);
void TVPDumpScriptEngine();
void TVPExecuteBytecode(const tjs_uint8 * content , size_t len , iTJSDispatch2 * context , tTJSVariant * result = NULL , const tjs_char * name = NULL);
...
bool TVPGetCommandLine(const tjs_char * name , tTJSVariant * value = NULL);
